...
namespace IIS.Programma_7
{
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Programma_7.Должность fДолжность;
        ...
        [PropertyStorage(new string[] {
                "Должность"})]
        [NotNull()]
        public virtual IIS.Programma_7.Должность Должность
        {
            get
            {
                ...
                IIS.Programma_7.Должность result = this.fДолжность;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Programma_7.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Programma_7.Сотрудник));
                }
            }
        }
    }
