...
namespace IIS.Programma_7
{
    ...
    public class Серверная : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Programma_7.Сотрудник fСотрудник;
        
        private IIS.Programma_7.DetailArrayOfКонтроллер fКонтроллер;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Programma_7.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Programma_7.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Programma_7.DetailArrayOfКонтроллер Контроллер
        {
            get
            {
                ...
                {
                    this.fКонтроллер = new IIS.Programma_7.DetailArrayOfКонтроллер(this);
                }
                IIS.Programma_7.DetailArrayOfКонтроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СервернаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяE", typeof(IIS.Programma_7.Серверная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СервернаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяL", typeof(IIS.Programma_7.Серверная));
                }
            }
        }
    }
