...
namespace IIS.Programma_7
{
    ...
    public class ОтчетОСервере : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Programma_7.РежимСервера fРежим;
        
        private IIS.Programma_7.Серверная fСерверная;
        
        private IIS.Programma_7.Расположение fРасположение;
        ...
        public virtual IIS.Programma_7.РежимСервера Режим
        {
            get
            {
                ...
                IIS.Programma_7.РежимСервера result = this.fРежим;
        ...
        [PropertyStorage(new string[] {
                "Расположение"})]
        [NotNull()]
        public virtual IIS.Programma_7.Расположение Расположение
        {
            get
            {
                ...
                IIS.Programma_7.Расположение result = this.fРасположение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереE", typeof(IIS.Programma_7.ОтчетОСервере));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереL", typeof(IIS.Programma_7.ОтчетОСервере));
                }
            }
        }
    }
